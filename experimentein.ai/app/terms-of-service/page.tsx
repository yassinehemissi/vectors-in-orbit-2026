    ...
    <main className="min-h-screen bg-neutral-50 px-6 py-16 text-neutral-900">
      <div className="mx-auto w-full max-w-3xl rounded-[32px] border border-neutral-200/70 bg-white p-8 shadow-sm">
        ...
        <div className="mt-8 space-y-6 text-sm text-neutral-600">
          <p>
            By accessing or using Experimentein.ai (Experimentein), you agree to
            the following terms.
          </p>
          ...
          <section>
            ...
            <p className="mt-2">
              All outputs are generated from public research and automated
              systems. Users are responsible for verifying results
              independently.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Some features require an account and available credits.
            </p>
            ...
            <p className="mt-2">
              Abuse of the credit system may result in suspension.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              <li>
                The platform software and interface are owned by Experimentein.
              </li>
              <li>
                Scientific papers remain the property of their original authors
                and publishers.
              </li>
              <li>
                AI-generated summaries are provided without ownership
                guarantees.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 font-semibold text-neutral-900">
              Email: contact@experimentein.ai
            </p>
          </section>
        </div>
      </div>
